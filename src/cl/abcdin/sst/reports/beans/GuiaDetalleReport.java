...
public class GuiaDetalleReport extends CommandReport {
	...
	protected Collection getData(Map map, HttpServletRequest request) throws Exception {
		...
		List<Accesorio> accesoriosAux = accesorioDAO.listAccesoriosFromIdGuia(filterguia);
		
		ot.setAccesoriosListReport(accesoriosAux);
