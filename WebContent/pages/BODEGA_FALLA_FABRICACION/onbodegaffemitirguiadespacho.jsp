...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/pages/BODEGA_FALLA_FABRICACION/onbodegaffemitirguiadespacho.js?<%= version %>"></script>
</head>
<body>
	<div class="main_body">
								...
								<tr>
									<td width="50%">
										<fieldset class="">
											...
											<label for="transportista.nombre">Transportista</label>
											<label id="transportista.nombre" name="transportista.nombre" style="width: 251px;"></label>
											
											<input type="hidden" id="transportista.id" name="transportista.id"/>
										</fieldset>
									</td>
									<td width="50%">
										<fieldset class="">
