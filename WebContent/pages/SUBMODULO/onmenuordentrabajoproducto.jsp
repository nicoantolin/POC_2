...
<body>
	<div id="onmenuordentrabajoproductoPanel">
				...
				<tr>
					<td width="100%">
						<fieldset>
							...
							<label style="width:220px;" for="numeroIncidenteMarca">numero incidente marca</label>
							<label style="width:600px;" id="numeroIncidenteMarca">&nbsp;</label>
