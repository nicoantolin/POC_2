var initonmenurecibirotproductosp = function() {
	
	var isLoad = false;
	$('#onmenurecibirotproductosp').click(function(){
		if(!isLoad) {
			loadonmenurecibirotproductosp(ordenTrabajo);
			isLoad = true;
		}
...
var loadonmenurecibirotproductosp = function(ordenTrabajo) {
