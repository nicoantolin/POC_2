...
<body>
	<div id="onmenurecibirotrecepcionPanel" >
	   			...
	   			<tr>
	   				<td width="50%">
	   					<fieldset>
	   						...
	   						<input type="text" name="fechaRecepcion" id="fechaRecepcion" class="fechaHora dateTimeDDMMYYYYhhmm required" format="dd/MM/yyyy HH:mm" readOnly="readonly"/>
   				...
   				<tr>
	   				<td width="100%">		   				
	   					<fieldset>
							...
							<textarea rows="3" style="width: 75%"  id="condiciones" name="condiciones"></textarea>
	   					</fieldset>	  
	   					<br> 				
	   					<fieldset class="fieldset_botonera_center">
							...
							<input type="button" value="Rechazar recepción" id="rechazarRecepcion" name="rechazarRecepcion">
