var estado;
var initonbodegaffexternodetalleproducto = function() {
	
	
	$('#onbodegaffexternodetalleproducto').click(function(){
...
var loadonbodegaffexternodetalleproducto = function(despacho) {
	$('#productos').loadData([despacho]);
};
