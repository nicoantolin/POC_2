...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/pages/ADMINISTRACION/onmenupartesmantenedor.js?<%= version %>"></script>
</head> 
<body>
	<div class="main_body">
		...
		<div class="wrapper">
			<div class="container">
				<h1>ADMINISTRAR PARTES A REVISAR DE LOS PRODUCTOS</h1>
				 <div id="tabs">
					<ul>
		 ...
		 <div id="mantenedorpartes" title="partes">
			<form action="" id="partesForm" name="partesForm">
