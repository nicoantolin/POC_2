...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/pages/ADMINISTRACION/onmenufamiliasexcluidasserie.js?<%= version %>"></script>
</head>
<body>
	<div class="main_body">
		...
		<div class="wrapper">
			<div class="container">
				<h1>FAMILIAS DE PRODUCTOS EXCLUIDAS DE VALIDACIÓN DE NÚMERO DE SERIE</h1>
				<div class="marco">
