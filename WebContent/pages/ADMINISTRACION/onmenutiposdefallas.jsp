...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/pages/ADMINISTRACION/onmenutiposdefallas.js?<%= version %>"></script>
</head> 
<body>
	<div class="main_body">
		...
		<div class="wrapper">
			<div class="container">
				<h1>ADMINISTRAR TIPOS DE FALLAS DE LOS PRODUCTOS</h1>
				 <div id="tabs">
					<ul>
		...
		<div id="mantenedorTipoFalla" title="Tipo de Falla">
			<form action="" id="tipoFallaForm" name="tipoFallaForm">
