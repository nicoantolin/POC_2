$(document).ready(function() {
	...
	var saveFamilias = function(sel, nosel){
		...
		SSTFacade.saveFamiliasExcluidas(sel,nosel,{async:false,callback:function(){
			$.alerts.okButton = '&nbsp;Ok&nbsp;';
	...
	$("#familias").flexigrid({
		...
		multisel:false,
		singleSelect:true,
		dwrFunction:SSTFacade.listFamiliasExcluidasByFilter,
		tipo: 'famExc',
		seccion: 70001000,
