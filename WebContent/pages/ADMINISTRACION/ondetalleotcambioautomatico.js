...
$(document).ready(function() {
	...
	if(ubicacion.tipo != 'SC' && ordenTrabajo.ticketCambio != null && ordenTrabajo.ticketCambio > 0){
		$('#btnTicketDeCambio').attr('disabled', false);
	} else {
		$('#btnTicketDeCambio').attr('disabled',true);	
	}
	...
	loadSubmodulosByPage('ondetalleotcambioautomatico','tabs', true, ordenTrabajo, true);
