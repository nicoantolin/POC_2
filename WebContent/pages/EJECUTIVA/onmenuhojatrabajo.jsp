...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/pages/EJECUTIVA/onmenuhojatrabajo.js?<%= version %>"></script>
</head>
<body>
	<div class="main_body">
		...
		<div class="wrapper">
			<div class="container">
						...
						<form id="filtro_buscador_avanzado" name="filtro_buscador_avanzado">
							<table class="table_plana" width="100%">
								<tr>
									...
									<td width="33%">
										<fieldset>
											<label for="fechaRecepcionOtInicio" style="width : 160px;">RECEPCION DESDE</label>
											<input type="text" id="fechaRecepcionOtInicio" name="fechaRecepcionOtInicio" class="fecha dateDDMMYYYY"/>
											<label for="fechaRecepcionOtFin" style="width : 160px;">RECEPCION HASTA</label>
											<input type="text" id="fechaRecepcionOtFin" name="fechaRecepcionOtFin" class="fecha dateDDMMYYYY"/>
				   							<label for="fechaInicio" style="width : 160px;">CREACION DESDE</label>
				   							<input type="text" name="fechaInicio" id="fechaInicio" class="fecha dateDDMMYYYY">
				   							<label for="fechaTermino" style="width : 160px;">CREACION HASTA</label>
											...
											<label for="ccalidadAprueba" ; ">C. de calidad</label>
											<select id="ccalidadAprueba" name="ccalidadAprueba">
												<option value="">[seleccione]</option>
											...
											<input type="text" id="idDocumento" name="idDocumento" class="number" style="width:172px; margin-left:5px" placeholder="N° DOCUMENTO">
										</fieldset>
									</td>
								</tr>
								<tr>
				...
				<div class="marco" id="hojasTrabajo">
					<h1>Hoja de Trabajo (Doble click para ver el detalle de la OT)</h1>
				</div>
		...
		<div id="popup" title="Ejecutivas">
			<form action="" id="popupForm" name="popupForm">
				<fieldset class="fieldset_popup">
					<label for="idEjecutivaTraspasar">Ejecutiva</label>
					<select id="idEjecutivaTraspasar" name="idEjecutivaTraspasar" style="text-transform: uppercase"></select>
				</fieldset>
			</form>
		</div>
	</div>
