...
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/BODEGA/onbodegatrasladarproductosaff.js?<%= version %>"></script>
</head>
<body>
	<div class="main_body">
								...
								<tr>
									...
									<td width="50%">
										<fieldset>
											...
											<select id="ubicacionInterna" name="ubicacionInterna"></select>
											
											<label for="tipoCambio">Tipo Cambio</label>
											<select id="tipoCambio" name="tipoCambio"></select>
