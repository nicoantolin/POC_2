...
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/BODEGA/onbodegacontrato.js?<%= version %>"></script>
					         ...
					         <tr>
					         	<td colspan="2">
					            	<fieldset>			            		
					            		...
					            		<input type="checkbox" id="ot.contratoEmitido" name="ot.contratoEmitido" style="float: left; margin: 5px; width: 0;">
					            		<label for="ot.contratoEmitido" style="text-align:left; float: right; width: 97%">Servicio técnico no emitio contrato</label>
